...
const TopAuther = () => {
  return (
    <div className="w-full bg-[#fbeded] py-8 grid grid-cols-12">
      <aside className='col-start-2 col-span-3 md:col-start-3 md:col-span-2 flex items-center md:block md:pr-2'>
        <img src={author} alt="" />
      </aside>
      <aside className='col-start-6 col-span-8 md:col-span-3  md:pl-5 py-16  text-left'>
      ...
      <aside className='col-start-9 col-span-3 px-2 hidden  md:grid grid-cols-12'>
